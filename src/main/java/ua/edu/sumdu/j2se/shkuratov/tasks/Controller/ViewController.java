...
public class ViewController {
    public void chosenOption(int i) throws IOException {
        ...
        PrintCalendarController printCalendarController = new PrintCalendarController();
        ...
        switch (i) {
            ...
            case 4:
                ...
                break;
            case 5:
                printCalendarController.printCalendar(src);
                break;
            default:
